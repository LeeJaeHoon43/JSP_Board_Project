...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	/*
    		1. 폼 액션으로 날아온 폼 데이터들(parameter)을 얻어온다.
    		2. DAO객체를 공개된 메서드를 호출하여 주소값을 얻어오기.
    		3. 회원가입 승인 전에 이미 DB에 존재하는 ID인지 검사.(confirmId)
    		4. 이미 회원가입 된 id라면 alert로 아이디가 중복되었다고 경고한 후 , location.href="user_join.jsp";
   	...
   	<% } else { // 이미 가입된 회원이 없을 경우.
   			UserVO vo = new UserVO(id, pw, name, email, address); // 객체 생성.
