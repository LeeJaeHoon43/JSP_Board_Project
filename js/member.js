...
function joinConfirm(){
	...
	//document는 문서를 뜻합니다.
	//name이 reg_form안에 name id 인 태그 안에, value를 뜻함.
	
	// 아이디 입력 칸에 아무것도 입력을 안했을 경우.
